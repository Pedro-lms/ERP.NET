...
namespace Pedro.Scheduler.Data.Migrations
{
    ...
    partial class DDD
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Employee", b =>
                {
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Paycheck", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.PayRate", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Project", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Schedule", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Employee", b =>
                {
                    b.HasOne("Pedro.Scheduler.Core.Entities.PayRate", "PayRate")
                        .WithMany()
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Paycheck", b =>
                {
                    b.HasOne("Pedro.Scheduler.Core.Entities.Employee", "Employee")
                        .WithMany("Paychecks")
            ...
            modelBuilder.Entity("Pedro.Scheduler.Core.Entities.Schedule", b =>
                {
                    ...
                    b.HasOne("Pedro.Scheduler.Core.Entities.Project", "Project")
                        .WithMany()
